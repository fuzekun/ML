...
from web import settings  # 项目中的settings文件，配置了BASEDIR路径，在这里无需关注
...
def get_authcode_img(request):
    ...
    #这两句话用来指定具体的文字，但是有的文字没法加载，就直接使用系统的幼圆字体
    #font_path = os.path.join(settings.BASE_DIR,"firstWEB\static","font","cerepf__.ttf")  # 获取字体，注意有些字体无法显示数字
    #print(font_path)


    font_obj = ImageFont.truetype("arial.ttf",32)  # 创建一个字体对象
